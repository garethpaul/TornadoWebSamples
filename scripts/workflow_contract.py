...
def validate(workflow):
    ...
    if len(re.findall(r"^        run: python -m pip install -r requirements\.txt -r test-requirements\.txt$", workflow, re.MULTILINE)) != 1:
        errors.append("install the exact pinned dependency sets once")
